...
if e:
    if len(e)==1:
         ...
         resultfile.write("Unfortunately an error occured while testing the following example setup:\n")
         resultfile.write("\n")
    else:
         print("Errors occured while testing the following example setups:")
         resultfile.write("Unfortunately errors occured while testing the following example setups:\n")
         resultfile.write("\n")
    n = range(len(e))
    for x in n:
         print("") 
