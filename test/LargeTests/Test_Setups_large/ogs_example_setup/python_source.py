...
constant_contributions = np.load("./Test_Setups_large/ogs_example_setup/constant_contributions.npy")
salinity_prefactors = np.load("./Test_Setups_large/ogs_example_setup/salinity_prefactors.npy")
cumsum_salinity = np.zeros_like(salinity_prefactors)
calls = np.zeros_like(salinity_prefactors)
counter = np.zeros((1), dtype=int)

cumsum_savename = "./Test_Setups_large/ogs_example_setup/cumsum_salinity.npy"
calls_savename = "./Test_Setups_large/ogs_example_setup/calls_in_last_timestep.npy"

t_write = 10000000.0
cell_information = CellInformation('./Test_Setups_large/ogs_example_setup/source_domain.vtu')
